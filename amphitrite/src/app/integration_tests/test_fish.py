...
def test_get_pedigree_tree():
    pedigree_tree = get_pedigree_tree('amphiadmin', '9bd0baa4-4bdb-441e-a54a-25fb8d6b0edb')
    ...
    pedigree_tree = get_pedigree_tree('amphiadmin', '58eaf9f8-4520-43bd-90eb-9cd4a169007c')
